...
| GLM 5.3 Flash | — | TRANSPORT FIXED (route-binding remap, 20539c6): TP16 completions now status 0 through ALL 45 LAYERS — the fleet executes the whole model. NEW final-stage bug: completion emit reports status 17 w/ tokcnt 0 after the clean walk (final head/MTP/accounting class). Named by live diagnostics | — | — | main 20539c6 | 2026-08-29 |
