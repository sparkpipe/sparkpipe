...
| GLM 5.3 Flash | — | HC twin CORRECTED+deployed (hidden sums verified rank0==rank15); still token-0: localized to layer-34 KDA sublayer emitting exact zero output (partials zero from layer 33; pack exonerated by checksums; head/emit exonerated by probes) — one kernel-input bug from real tokens (7490f5c) | — | — | main 7490f5c | 2026-08-29 |
