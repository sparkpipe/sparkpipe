...
Last update: 2026-08-19 05:39 UTC (RACE ON: device side COMPLETE - W1/W2/W4/W3/W6/W8 all landed with parity evidence (CI green at 9ba4fcc); W7 selector dispatch = the last code piece (27B mid-edit); then end-to-end parity + k-sweep k=4/7/8/12 vs 8.02; flash verification build live; no HWM change since 8.03)
