...
Last update: 2026-08-19 03:07 UTC (27B: W1 DONE (packer+format rewritten for DFlash2, 81-tensor inventory verified, selector reuses Markov slots verbatim); W8 oracle first-cut done, pinning to the vLLM unit tests next; weights downloaded to spark3; Flash: spark4 verification of 47c24f2 still pending; CI green; no HWM change since 8.03)
