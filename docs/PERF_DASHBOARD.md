...
| Qwen 3.8 27B (TP1) | **8.00 FP8** (tiled decode; 3.10 BF16) [validated] | ~2.7 est (D=2) | - | - | - |
...
Last update: 2026-08-18 06:30 UTC (27B FP8 tiled-decode HWM 8.00 - exceeds 7.88 reference)
