...
Last update: 2026-08-19 07:20 UTC (Parity triple-confirmed (27B lane's third independent PASS; TP1-adapter = the target_mismatch root); trajectory losslessness fix = the ONLY remaining correctness gate (GLM-credited; both lanes active); k-sweep follows on the FP8 root vs 8.02. spark3 serving active (BF16 root - FP8 for the sweep). DSV4-FLASH PAUSED; CI green; no HWM change since 8.03)
