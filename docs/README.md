...
- [`PAIRED_DUAL_LINK_ALLREDUCE.md`](archive/PAIRED_DUAL_LINK_ALLREDUCE.md): adaptive
  two-rail collective.
- [`DSV4_FLASH_TP4_PP4.md`](archive/DSV4_FLASH_TP4_PP4.md): canonical large-model
  resident layout.
...
- [`GLM52_SM121_REQUIRED_CUDA_MODULE.md`](archive/GLM52_SM121_REQUIRED_CUDA_MODULE.md):
  required GLM CUDA boundary.
- [`K3_PACK_FORMAT_V2.md`](archive/K3_PACK_FORMAT_V2.md): K3 resident pack format.
