...
| 9 | cell E2E | **PACK SET GENERATING (r5)** — 16-rank stagepack set (encoder,dit,video_vae,audio_vae; TP4xPP4 13/13/13/11) queued on sparke as minimax-r5-c9-packset writing /mnt/model-warm/staging/minimax-lane/packs/h3.bf16.tp4pp4 (tools/minimax_h3_stagepack.py per rank, <=1GB RSS streaming); deployment generator unchanged (frozen block 17408-18431, port 18383); live cell + ABI seam numbers after pack placement |
