...
work="${MINIMAX_H3_V5_WORK:-${TMPDIR:-/tmp}/minimax_h3_v5_gate}"
warm="${MINIMAX_H3_V5_WARM:-/mnt/model-warm/minimax-h3}"
...
"${nvcc_bin}" -O2 -std=c++17 \
	...
	"${script_directory}/spark_minimax_h3_v5_gate.cu"

"${work}/minimax_h3_v5_gate" "${fixtures}" "${work}/weights" "${work}/weights/manifest.txt"
