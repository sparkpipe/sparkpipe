...
{
	if ( tp_degree == 0u || tp_degree > SPARK_QWEN4_FLASH_MODEL_ATTN_QUERY_HEAD_COUNT || tp_rank >= tp_degree || (SPARK_QWEN4_FLASH_MODEL_ATTN_QUERY_HEAD_COUNT % tp_degree) != 0u || (SPARK_QWEN4_FLASH_MODEL_ATTN_KV_HEAD_COUNT % tp_degree) != 0u || (SPARK_QWEN4_FLASH_MODEL_ATTN_KV_HEAD_COUNT / tp_degree) == 0u )
...
extern "C" cudaError_t SparkQwen4FlashConfigureCudaKernels(void)
{
    ...
    return cudaFuncSetAttribute(
        ...
        cudaFuncAttributeMaxDynamicSharedMemorySize,
        (int)(SPARK_QWEN4_FLASH_MODEL_ATTN_QUERY_DIMENSION * sizeof(float)));
}
