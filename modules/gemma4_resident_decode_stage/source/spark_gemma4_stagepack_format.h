...
#if SPARK_GEMMA4_MODEL_MOE_BLOCK
	case SPARK_GEMMA4_STAGEPACK_TENSOR_LAYER_POST_FEEDFORWARD_NORM_1:
	case SPARK_GEMMA4_STAGEPACK_TENSOR_LAYER_PRE_FEEDFORWARD_NORM_2:
	case SPARK_GEMMA4_STAGEPACK_TENSOR_LAYER_POST_FEEDFORWARD_NORM_2:
#endif
		shape->rows = 1u;
		shape->columns = SPARK_GEMMA4_MODEL_HIDDEN_DIMENSION;
		return(0);
