...
#endif
/* Contract F8.6: the driver's adapter-configuration JSON shape is pinned
 * as v1. The loader treats an absent schema_version member as v1
 * (grandfathered deployments) and rejects any explicit other value. */
#define SPARK_K3_SERVING_ADAPTER_CONFIGURATION_SCHEMA_VERSION 1u
