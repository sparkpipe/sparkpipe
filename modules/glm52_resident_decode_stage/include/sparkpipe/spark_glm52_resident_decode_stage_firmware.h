...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_NODE_CONTEXT_ABI_VERSION \
	SPARK_LLM_STAGE_NODE_CONTEXT_ABI_VERSION
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_ABI_VERSION \
	SPARK_LLM_STAGE_FRAME_CONTEXT_ABI_VERSION
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BATCH_VIEW_ABI_VERSION \
	SPARK_LLM_STAGE_BATCH_VIEW_ABI_VERSION
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_COUNT SPARK_LLM_STAGE_COUNT
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_LAYERS_PER_STAGE \
	SPARK_LLM_STAGE_LAYERS_PER_STAGE
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_ACTIVE_SEQUENCE_COUNT \
	SPARK_BATCH_BUCKET
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_INPUT_ROW_COUNT SPARK_LLM_STAGE_MAX_INPUT_ROW_COUNT
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_PIPELINE_SLOT_COUNT SPARK_LLM_STAGE_MAX_PIPELINE_SLOT_COUNT
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BOUNDARY_ELEMENT_COUNT \
	(2u * SPARK_GLM52_MODEL_HIDDEN_DIMENSION)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BOUNDARY_ELEMENT_BYTES SPARK_LLM_STAGE_BOUNDARY_ELEMENT_BYTES
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_SIDEBAND_KIND SPARK_LLM_STAGE_DSA_SIDEBAND_KIND
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_ATTN_SPLIT_PARTITIONS SPARK_LLM_STAGE_ATTN_SPLIT_PARTITIONS
