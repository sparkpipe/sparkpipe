...
static inline int32_t SparkGlm52StagePackExpectedShape(uint32_t tensor_kind,uint32_t layer_index,uint32_t expert_codec,SparkGlm52StagePackTensorShape *shape)
{
	uint32_t global;
	if ( shape == 0 || tensor_kind >= SPARK_GLM52_STAGEPACK_TENSOR_KIND_COUNT )
		return(-1);
	...
	case SPARK_GLM52_STAGEPACK_TENSOR_LM_HEAD: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_OUTPUT_VOCAB_COUNT,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_FINAL_NORM:
	case SPARK_GLM52_STAGEPACK_TENSOR_ATTN_NORM:
	case SPARK_GLM52_STAGEPACK_TENSOR_POST_ATTN_NORM: SparkGlm52StagePackShapeBf16(shape,1u,1u,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_Q_A: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_QUERY_A_DIMENSION,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_Q_A_NORM: SparkGlm52StagePackShapeBf16(shape,1u,1u,SPARK_GLM52_MODEL_QUERY_A_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_Q_B: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_HEAD_COUNT * SPARK_GLM52_MODEL_QK_HEAD_DIMENSION,SPARK_GLM52_MODEL_QUERY_A_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_KV_A: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_CACHE_TOKEN_ELEMENTS,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_KV_A_NORM: SparkGlm52StagePackShapeBf16(shape,1u,1u,SPARK_GLM52_MODEL_LATENT_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_KV_B_KEY_TRANSPOSED: SparkGlm52StagePackShapeBf16(shape,SPARK_GLM52_MODEL_HEAD_COUNT,SPARK_GLM52_MODEL_LATENT_DIMENSION,SPARK_GLM52_MODEL_QK_NOPE_HEAD_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_KV_B_VALUE: SparkGlm52StagePackShapeBf16(shape,SPARK_GLM52_MODEL_HEAD_COUNT,SPARK_GLM52_MODEL_VALUE_HEAD_DIMENSION,SPARK_GLM52_MODEL_LATENT_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_ATTN_OUTPUT: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_HIDDEN_DIMENSION,SPARK_GLM52_MODEL_HEAD_COUNT * SPARK_GLM52_MODEL_VALUE_HEAD_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_INDEX_Q: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_DSA_INDEX_QUERY_DIMENSION,SPARK_GLM52_MODEL_QUERY_A_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_INDEX_K: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_DSA_INDEX_HEAD_DIMENSION,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_INDEX_HEAD: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_DSA_INDEX_HEAD_COUNT,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_INDEX_NORM_WEIGHT:
	case SPARK_GLM52_STAGEPACK_TENSOR_INDEX_NORM_BIAS: SparkGlm52StagePackShapeBf16(shape,1u,1u,SPARK_GLM52_MODEL_DSA_INDEX_HEAD_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_DENSE_GATE_UP: SparkGlm52StagePackShapeBf16(shape,1u,2u * SPARK_GLM52_MODEL_DENSE_INTERMEDIATE_DIMENSION,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_DENSE_DOWN: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_HIDDEN_DIMENSION,SPARK_GLM52_MODEL_DENSE_INTERMEDIATE_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_ROUTER: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_MOE_EXPERT_COUNT,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_ROUTER_CORRECTION: shape->payload_type = SPARK_GLM52_STAGEPACK_PAYLOAD_F32; shape->group_count = 1u; shape->rows = 1u; shape->columns = SPARK_GLM52_MODEL_MOE_EXPERT_COUNT; return(0);
	...
	case SPARK_GLM52_STAGEPACK_TENSOR_EXPERT_DOWN:
		...
		return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_SHARED_GATE_UP: SparkGlm52StagePackShapeBf16(shape,1u,2u * SPARK_GLM52_MODEL_MOE_INTERMEDIATE_DIMENSION,SPARK_GLM52_MODEL_HIDDEN_DIMENSION); return(0);
	case SPARK_GLM52_STAGEPACK_TENSOR_SHARED_DOWN: SparkGlm52StagePackShapeBf16(shape,1u,SPARK_GLM52_MODEL_HIDDEN_DIMENSION,SPARK_GLM52_MODEL_MOE_INTERMEDIATE_DIMENSION); return(0);
	default: return(-6);
	}
}
