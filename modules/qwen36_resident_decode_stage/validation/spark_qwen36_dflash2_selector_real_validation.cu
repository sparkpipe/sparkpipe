 ...
 * SparkQwen36DsparkSelectorEmit, the module's own inline sequence, on the real
 * 248320 x 5120 head.
 *
...
int main(int argc, char **argv)
{
	...
	SPARK_DFLASH2_CUDA(cudaMalloc((void **)&workspace.chunk_keys,(size_t)SparkQwen36DsparkHeadTopKChunkKeyCount(slots,top_k) * sizeof(uint64_t)));
	...
	SPARK_DFLASH2_CUDA(SparkQwen36DsparkSelectorEmit(0,&head_view,hidden_device,projection_device,
