 ...
 * SPARK_QWEN36_DSPARK_BLOCK_SIZE positions, position 0 carries the COMMITTED
 ...
 * which is also what SPARK_QWEN36_RESIDENT_DECODE_STAGE_DSPARK_BLOCK_SIZE (7)
...
{
	uint64_t *chunk_keys;       /* SparkQwen36DsparkHeadTopKChunkKeyCount(slots, top_k) */
