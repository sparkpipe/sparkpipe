...
typedef enum SparkQwen36DsparkTensorKind
{
	...
	SPARK_QWEN36_DSPARK_TENSOR_SELECTOR_PRED = 12,         
	SPARK_QWEN36_DSPARK_TENSOR_SELECTOR_SUCC = 13,         
	SPARK_QWEN36_DSPARK_TENSOR_SELECTOR_HIDDEN_PROJ = 14,  
	SPARK_QWEN36_DSPARK_TENSOR_FINAL_NORM = 15,
	SPARK_QWEN36_DSPARK_TENSOR_HIDDEN_NORM = 16,
	SPARK_QWEN36_DSPARK_TENSOR_CONV_ATTN_BASE = 17,  
	SPARK_QWEN36_DSPARK_TENSOR_CONV_ATTN_PROJ = 18,  
	SPARK_QWEN36_DSPARK_TENSOR_CONV_MLP_BASE = 19,   
	SPARK_QWEN36_DSPARK_TENSOR_CONV_MLP_PROJ = 20,   
