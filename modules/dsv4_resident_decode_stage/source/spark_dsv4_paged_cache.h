...
/* Sentinel shared with the paged-KV family core; this substrate keeps
 * its own page-flavored name. */
#define SPARK_DSV4_PAGED_CACHE_NO_PAGE SPARK_PAGED_KV_NO_BLOCK
