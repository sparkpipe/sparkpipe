MODULE_FAMILY := dsv4
MODULE_IDENTIFIER_PREFIX := spark.dsv4.pro.resident_decode_stage.linear_fp8.expert_mxfp4.kv_bf16.h7168.l61.e384.k6.ga0731
...
MODULE_TARGET := cuda.sm121.dsv4.pro.resident_decode_stage.linear_fp8.expert_mxfp4.kv_bf16
...
MODULE_COMPILE_FLAGS := -DSPARK_DSV4_MODULE_BUILD=1 -DSPARK_BATCH_BUCKET=1024u -DSPARK_DSV4_PRO_BUILD=1
