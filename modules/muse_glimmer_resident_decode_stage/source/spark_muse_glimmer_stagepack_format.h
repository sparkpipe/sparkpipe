...
typedef enum SparkMuseGlimmerStagePackTensorKind
{
	...
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_INPUT_NORM = 22,
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_POST_ATTENTION_NORM = 23,
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_PRE_FFN_NORM = 24,
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_POST_FFN_NORM = 25,
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_QGKV = 26,
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_ATTN_OUTPUT = 27,
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_ATTN_GATE_UP = 28,
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_MLP_DOWN = 29,
	SPARK_MUSE_GLIMMER_STAGEPACK_TENSOR_KIND_COUNT = 30
