...
static inline void SparkQwen38MaxStagePackShapeInit(SparkQwen38MaxStagePackTensorShape *shape)
{
	shape->rows = 0u;
	shape->columns = 0u;
	shape->natural_format = SPARK_QWEN38_MAX_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16;
	shape->layer_class = SPARK_QWEN38_MAX_STAGEPACK_CLASS_EVERY_LAYER;
}
...
static inline int32_t SparkQwen38MaxStagePackShapeEveryLayer(uint32_t tensor_kind, SparkQwen38MaxStagePackTensorShape *shape)
{
	...
	switch ( tensor_kind )
	{
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_ATTENTION_NORM:
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MLP_NORM:
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MOE_SHARED_GATE_WEIGHT:
		shape->rows = 1u;
		shape->columns = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MOE_GATE:
		shape->rows = SPARK_QWEN38_MAX_MODEL_ROUTED_EXPERT_COUNT;
		shape->columns = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MOE_W1:
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MOE_W3:
		shape->rows = SPARK_QWEN38_MAX_MODEL_ROUTED_EXPERT_COUNT * SPARK_QWEN38_MAX_MODEL_EXPERT_INTERMEDIATE_DIMENSION;
		shape->columns = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		shape->natural_format = SPARK_QWEN38_MAX_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_FP8_E4M3_F32B128;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MOE_DOWN:
		shape->rows = SPARK_QWEN38_MAX_MODEL_ROUTED_EXPERT_COUNT * SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		shape->columns = SPARK_QWEN38_MAX_MODEL_EXPERT_INTERMEDIATE_DIMENSION;
		shape->natural_format = SPARK_QWEN38_MAX_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_FP8_E4M3_F32B128;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MOE_SHARED_GATE:
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MOE_SHARED_UP:
		shape->rows = SPARK_QWEN38_MAX_MODEL_EXPERT_INTERMEDIATE_DIMENSION;
		shape->columns = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_MOE_SHARED_DOWN:
		shape->rows = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		shape->columns = SPARK_QWEN38_MAX_MODEL_EXPERT_INTERMEDIATE_DIMENSION;
		return(0);
	default:
...
{
	shape->layer_class = SPARK_QWEN38_MAX_STAGEPACK_CLASS_GDN_LAYER;
	switch ( tensor_kind )
	{
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_QKV:
		shape->rows = SPARK_QWEN38_MAX_MODEL_GDN_CONV_CHANNELS;
		shape->columns = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_GATE:
		shape->rows = SPARK_QWEN38_MAX_MODEL_GDN_VALUE_DIMENSION;
		shape->columns = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_BETA:
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_DECAY:
		shape->rows = SPARK_QWEN38_MAX_MODEL_GDN_VALUE_HEAD_COUNT;
		shape->columns = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_OUTPUT:
		shape->rows = SPARK_QWEN38_MAX_MODEL_HIDDEN_DIMENSION;
		shape->columns = SPARK_QWEN38_MAX_MODEL_GDN_VALUE_DIMENSION;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_CONV_WEIGHT:
		shape->rows = SPARK_QWEN38_MAX_MODEL_GDN_CONV_CHANNELS;
		shape->columns = SPARK_QWEN38_MAX_MODEL_GDN_CONV_KERNEL;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_A_LOG:
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_DT_BIAS:
		shape->rows = 1u;
		shape->columns = SPARK_QWEN38_MAX_MODEL_GDN_VALUE_HEAD_COUNT;
		shape->natural_format = SPARK_QWEN38_MAX_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_F32;
		return(0);
	case SPARK_QWEN38_MAX_STAGEPACK_TENSOR_GDN_NORM:
		shape->rows = 1u;
		shape->columns = SPARK_QWEN38_MAX_MODEL_GDN_HEAD_VALUE_DIMENSION;
		return(0);
	default:
		return(-1);
	}
