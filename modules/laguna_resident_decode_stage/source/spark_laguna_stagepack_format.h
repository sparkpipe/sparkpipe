...
#define SPARK_LAGUNA_STAGEPACK_MTP_LAYER (UINT32_MAX - 1u)
...
#define SPARK_LAGUNA_STAGEPACK_TENSOR_MTP_FC 100u
#define SPARK_LAGUNA_STAGEPACK_TENSOR_MTP_FINAL_NORM 103u
