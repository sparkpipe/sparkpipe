# GLM5_NEXT resident decode-stage firmware
...
The fixed stage program is specialized for SM121 GLM 5.3 Flash BF16 decode with 6144 hidden elements, 64 MLA heads, 512 latent elements, 64 adjacent-pair RoPE elements, 2048 selected context tokens, 64-token KV blocks, a 256-token restricted vocabulary head, and depth-2 MXFP4 MTP draft verification.
...
BF16 dense MLP layer progression for GLM 5.3 Flash's first dense layers
external completion
```
...
```sh
GLM5_NEXT_MODEL_DIR=/home/spark1/models/hf/nvidia/GLM-5.2-NVFP4 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage validate_layer0_dense_bf16 MAX_STAGE_MICROSECONDS=10000
```
...
GLM5_NEXT_MODEL_DIR=/home/spark1/models/hf/nvidia/GLM-5.2-NVFP4 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage package_layer0_dense_bf16 MAX_STAGE_MICROSECONDS=10000
```
...
GLM5_NEXT_MODEL_DIR=/home/spark1/models/hf/nvidia/GLM-5.2-NVFP4 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage package_layer0_bf16 MAX_STAGE_MICROSECONDS=10000
```
...
```sh
GLM5_NEXT_MODEL_DIR=/home/spark1/models/hf/nvidia/GLM-5.2-NVFP4 \
GLM5_NEXT_INPUT_TOKEN_ID=1000 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage package_layer0_embedding_bf16 MAX_STAGE_MICROSECONDS=10000
```
...
GLM5_NEXT_INPUT_TOKEN_ID=1000 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage package_layer0_prefill_bf16 MAX_STAGE_MICROSECONDS=10000
```
...
GLM5_NEXT_INPUT_TOKEN_ID=1000 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage package_layer0_reference_bf16 MAX_STAGE_MICROSECONDS=10000
```
...
GLM5_NEXT_INPUT_TOKEN_ID=1000 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage package_layer0_full_reference_bf16 MAX_STAGE_MICROSECONDS=10000
```
...
GLM5_NEXT_INPUT_TOKEN_ID=1000 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage package_layer1_full_reference_bf16 MAX_STAGE_MICROSECONDS=10000

GLM5_NEXT_MODEL_DIR=/home/spark1/models/hf/nvidia/GLM-5.2-NVFP4 \
GLM5_NEXT_INPUT_TOKEN_ID=1000 \
PATH=/usr/local/cuda-13.0/bin:$PATH \
make -C modules/glm5_next_resident_decode_stage package_layer2_full_reference_bf16 MAX_STAGE_MICROSECONDS=10000
```
