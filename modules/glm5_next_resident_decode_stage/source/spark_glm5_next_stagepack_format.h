...
static inline int32_t SparkGlm5NextStagePackExpectedShape(uint32_t tensor_kind,uint32_t layer_index,uint32_t expert_codec,uint32_t tp_degree,SparkGlm5NextStagePackTensorShape *shape)
{
    ...
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_EMBEDDING:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_LM_HEAD:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_OUTPUT_VOCAB_COUNT,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_FINAL_NORM:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_ATTN_NORM:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_POST_ATTN_NORM:
        SparkGlm5NextStagePackShapeBf16(shape,1u,1u,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_Q_A:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_MLA_QUERY_A_DIMENSION,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_Q_A_NORM:
        SparkGlm5NextStagePackShapeBf16(shape,1u,1u,SPARK_GLM5_NEXT_MODEL_MLA_QUERY_A_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_Q_B:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_MLA_QUERY_B_DIMENSION,SPARK_GLM5_NEXT_MODEL_MLA_QUERY_A_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KV_A:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_MLA_KV_A_DIMENSION,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KV_A_NORM:
        SparkGlm5NextStagePackShapeBf16(shape,1u,1u,SPARK_GLM5_NEXT_MODEL_MLA_LATENT_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KV_B_KEY_TRANSPOSED:
        SparkGlm5NextStagePackShapeBf16(shape,SPARK_GLM5_NEXT_MODEL_MLA_HEAD_COUNT,SPARK_GLM5_NEXT_MODEL_MLA_LATENT_DIMENSION,SPARK_GLM5_NEXT_MODEL_MLA_QK_NOPE_HEAD_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KV_B_VALUE:
        SparkGlm5NextStagePackShapeBf16(shape,SPARK_GLM5_NEXT_MODEL_MLA_HEAD_COUNT,SPARK_GLM5_NEXT_MODEL_MLA_VALUE_HEAD_DIMENSION,SPARK_GLM5_NEXT_MODEL_MLA_LATENT_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_ATTN_OUTPUT:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION,SPARK_GLM5_NEXT_MODEL_MLA_ATTENTION_PROJECTION_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_INDEX_Q:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_INDEX_QUERY_DIMENSION,SPARK_GLM5_NEXT_MODEL_MLA_QUERY_A_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_INDEX_K:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_INDEX_HEAD_DIMENSION,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_INDEX_HEAD:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_INDEX_HEAD_COUNT,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_INDEX_NORM_WEIGHT:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_INDEX_NORM_BIAS:
        SparkGlm5NextStagePackShapeBf16(shape,1u,1u,SPARK_GLM5_NEXT_MODEL_INDEX_HEAD_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_INDEX_COMPRESS_APE:
        SparkGlm5NextStagePackShapeF32(shape,1u,SPARK_GLM5_NEXT_MODEL_INDEX_KPOOL,SPARK_GLM5_NEXT_MODEL_INDEX_HEAD_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_INDEX_COMPRESS_GATE:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_INDEX_HEAD_DIMENSION,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_DENSE_GATE_UP:
        SparkGlm5NextStagePackShapeBf16(shape,1u,2u * SPARK_GLM5_NEXT_MODEL_DENSE_INTERMEDIATE_DIMENSION,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_DENSE_DOWN:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION,SPARK_GLM5_NEXT_MODEL_DENSE_INTERMEDIATE_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_ROUTER:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_MOE_EXPERT_COUNT,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_ROUTER_CORRECTION:
        SparkGlm5NextStagePackShapeF32(shape,1u,1u,SPARK_GLM5_NEXT_MODEL_MOE_EXPERT_COUNT);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_EXPERT_UP_GATE:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_EXPERT_DOWN:
        ...
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_SHARED_GATE_UP:
        SparkGlm5NextStagePackShapeBf16(shape,1u,2u * SPARK_GLM5_NEXT_MODEL_MOE_INTERMEDIATE_DIMENSION,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_SHARED_DOWN:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION,SPARK_GLM5_NEXT_MODEL_MOE_INTERMEDIATE_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_QKV_BETA:
        SparkGlm5NextStagePackShapeBf16(shape,1u,2u * SPARK_GLM5_NEXT_MODEL_KDA_QKV_DIMENSION + SPARK_GLM5_NEXT_MODEL_KDA_QKV_DIMENSION + SPARK_GLM5_NEXT_MODEL_KDA_HEAD_COUNT,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_DECAY_GATE_DOWN:
        SparkGlm5NextStagePackShapeBf16(shape,1u,2u * SPARK_GLM5_NEXT_MODEL_KDA_LOW_RANK_GATE_BOTTLENECK,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_DECAY_UP:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_GATE_UP:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_KDA_QKV_DIMENSION,SPARK_GLM5_NEXT_MODEL_KDA_LOW_RANK_GATE_BOTTLENECK);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_Q_CONV:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_K_CONV:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_V_CONV:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_KDA_QKV_DIMENSION,SPARK_GLM5_NEXT_MODEL_KDA_SHORT_CONV_KERNEL);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_DECAY_BIAS:
        SparkGlm5NextStagePackShapeF32(shape,1u,1u,SPARK_GLM5_NEXT_MODEL_KDA_QKV_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_HEAD_LOG_SCALE:
    ...
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_KDA_OUT:
        ...
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_HC_ATTN_FN:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_HC_FFN_FN:
        SparkGlm5NextStagePackShapeF32(shape,1u,SPARK_GLM5_NEXT_MODEL_HC_MIX_DIMENSION,SPARK_GLM5_NEXT_MODEL_HC_FN_COLUMNS);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_HC_ATTN_BASE:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_HC_FFN_BASE:
        SparkGlm5NextStagePackShapeF32(shape,1u,1u,SPARK_GLM5_NEXT_MODEL_HC_MIX_DIMENSION);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_HC_ATTN_SCALE:
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_HC_FFN_SCALE:
        SparkGlm5NextStagePackShapeF32(shape,1u,1u,SPARK_GLM5_NEXT_MODEL_HC_SCALE_COUNT);
        break;
    case SPARK_GLM5_NEXT_STAGEPACK_TENSOR_MTP_EH_PROJ:
        SparkGlm5NextStagePackShapeBf16(shape,1u,SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION,2u * SPARK_GLM5_NEXT_MODEL_HIDDEN_DIMENSION);
        break;
