...
// libglm5_next_resident_decode_stage_<codec>_b1.a / _b2.a / ... / _b1024.a - one
...
// (SPARK_GLM5_NEXT_RESIDENT_DECODE_STAGE_MAX_ACTIVE_SEQUENCE_COUNT unflagged),
...
// Makefile's -DGLM5_NEXT_EXPERT_CODEC_NAME, so the six codec builds share this
...
// makes a variant-published glm5_next module a new module identity, not a rename
...
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX \
	"v2"
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B1 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b1." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B2 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b2." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B4 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b4." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B8 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b8." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B16 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b16." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B32 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b32." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B64 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b64." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B128 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b128." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B256 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b256." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B512 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b512." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX
#define SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B1024 \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_PREFIX ".b1024." \
	SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_SUFFIX

#if SPARK_BATCH_BUCKET == 1u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B1
#elif SPARK_BATCH_BUCKET == 2u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B2
#elif SPARK_BATCH_BUCKET == 4u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B4
#elif SPARK_BATCH_BUCKET == 8u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B8
#elif SPARK_BATCH_BUCKET == 16u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B16
#elif SPARK_BATCH_BUCKET == 32u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B32
#elif SPARK_BATCH_BUCKET == 64u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B64
#elif SPARK_BATCH_BUCKET == 128u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B128
#elif SPARK_BATCH_BUCKET == 256u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B256
#elif SPARK_BATCH_BUCKET == 512u
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B512
#else
#define SPARK_GLM5_NEXT_BATCH_TUNING_MODULE_ID SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B1024
#endif
...
// a top_k or expert-count change reprices every variant at once. For glm5_next
...
#define SPARK_GLM5_NEXT_BATCH_TUNING_GROUPED_PEAK_ROWS \
	((((SPARK_BATCH_BUCKET) * SPARK_GLM5_NEXT_MODEL_MOE_TOP_K + \
	SPARK_GLM5_NEXT_MODEL_MOE_EXPERT_COUNT - 1u) / \
	SPARK_GLM5_NEXT_MODEL_MOE_EXPERT_COUNT) * 2u)
#define SPARK_GLM5_NEXT_BATCH_TUNING_GROUPED_TILE_M \
	(SPARK_GLM5_NEXT_BATCH_TUNING_GROUPED_PEAK_ROWS <= 16u ? 16u : \
	SPARK_GLM5_NEXT_BATCH_TUNING_GROUPED_PEAK_ROWS <= 32u ? 32u : 64u)
...
// ceiling sizes.
static inline uint32_t SparkGlm5NextBatchVariantBucketCeiling(
...
static inline const char *SparkGlm5NextBatchVariantModuleId(
	uint32_t batch_bucket)
{
	switch (batch_bucket)
	{
	case 1u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B1);
	case 2u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B2);
	case 4u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B4);
	case 8u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B8);
	case 16u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B16);
	case 32u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B32);
	case 64u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B64);
	case 128u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B128);
	case 256u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B256);
	case 512u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B512);
	case 1024u:
		return(SPARK_GLM5_NEXT_BATCH_VARIANT_MODULE_ID_B1024);
	default:
		return(0);
	}
}
