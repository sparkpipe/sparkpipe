...
#
# usage: validate_qwen38_27b_dflash2_selector_cuda.sh [smoke|mid|full|tie] [OUTPUT_DIRECTORY]
#
...
binary="${output_directory}/spark_qwen38_27b_dflash2_selector_validation"
...
"${nvcc_binary}" -std=c++17 -gencode "arch=compute_${cuda_architecture#sm_},code=${cuda_architecture}" \
    ...
    "${script_directory}/spark_qwen38_27b_dflash2_selector_validation.cu" \
