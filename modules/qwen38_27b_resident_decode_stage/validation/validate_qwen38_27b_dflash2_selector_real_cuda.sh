...
#
# usage: validate_qwen38_27b_dflash2_selector_real_cuda.sh [OUTPUT_DIRECTORY]
# needs: SPARK_QWEN38_27B_DFLASH2_DRAFTER and SPARK_QWEN38_27B_TARGET pointing at the
...
"${nvcc_binary}" -std=c++17 -gencode "arch=compute_${cuda_architecture#sm_},code=${cuda_architecture}" \
    ...
    "${script_directory}/spark_qwen38_27b_dflash2_selector_real_validation.cu" \
