...
#define SPARK_QWEN38_27B_RESIDENT_DECODE_STAGE_MAX_MTP_DRAFT_TOKENS 10u
 ...
 * costs SPARK_QWEN38_27B_MODEL_ATTN_CACHE_TOKEN_ELEMENTS bf16 elements per
 ...
 *
 * MTP_DRAFT_AFTER (head stage only, SPARK_QWEN38_27B_STAGE_MTP=1): after the
 ...
 * SPARK_QWEN38_27B_SPEC_AUDIT.
 */
#define SPARK_QWEN38_27B_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_SPEC_AUDIT_EMIT_ALL 0x00000200u
/*
 ...
 */
#define SPARK_QWEN38_27B_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_PREFIX_RESUME 0x00000400u
/*
 ...
 */
#define SPARK_QWEN38_27B_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_GDN_CHECKPOINT 0x00000800u
/* Merge consolidation: origin/main named bits 0x200/0x400/0x800 for its
 * verify-checkpoint and persistent-prefix-pool flags; the unified
 * audit/resume/checkpoint flags above claim those bits, so main's flags move
 * to the next free bits (semantics unchanged, all six coexist). */
#define SPARK_QWEN38_27B_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_GDN_RESTORE_VERIFY_ROW 0x00001000u
...
#define SPARK_QWEN38_27B_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_GDN_PREFIX_SNAPSHOT_OUT 0x00002000u
#define SPARK_QWEN38_27B_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_GDN_PREFIX_RESTORE_IN 0x00004000u
 ...
 *
 * This was 7 while the kernel's SPARK_QWEN38_27B_DSPARK_BLOCK_SIZE is 8, so the
 ...
 *
 * DFlash2 view of the same constant: [C0 anchor + 7 mask tokens] = 8 rows,
 * 7 draft ids.
 */
