...
FAMILIES = {
	...
	"qwen36": {
		...
		"pairs": [
			...
			("QWEN36_ATTN_HEADS", "SPARK_QWEN36_MODEL_ATTENTION_HEAD_COUNT"),
			("QWEN36_KV_HEADS", "SPARK_QWEN36_MODEL_KV_HEAD_COUNT"),
			("QWEN36_ROPE_DIM", "SPARK_QWEN36_MODEL_ATTN_ROPE_DIMENSION"),
			("QWEN36_FFN_INTERMEDIATE", "SPARK_QWEN36_MODEL_FFN_INTERMEDIATE_DIMENSION"),
			("QWEN36_MTP_LAYERS", "SPARK_QWEN36_MODEL_MTP_LAYER_COUNT"),
			("QWEN36_ATTENTION_PERIOD", "SPARK_QWEN36_MODEL_ATTENTION_PERIOD"),
			("QWEN36_FULL_PHASE", "SPARK_QWEN36_MODEL_FULL_ATTENTION_PHASE"),
			("QWEN36_GDN_KEY_HEADS", "SPARK_QWEN36_MODEL_GDN_KEY_HEAD_COUNT"),
			("QWEN36_GDN_VALUE_HEADS", "SPARK_QWEN36_MODEL_GDN_VALUE_HEAD_COUNT"),
			("QWEN36_GDN_KEY_DIM", "SPARK_QWEN36_MODEL_GDN_HEAD_KEY_DIMENSION"),
			("QWEN36_GDN_VALUE_DIM", "SPARK_QWEN36_MODEL_GDN_HEAD_VALUE_DIMENSION"),
			("QWEN36_GDN_CONV_KERNEL", "SPARK_QWEN36_MODEL_GDN_CONV_KERNEL"),
		],
	},
	"dsv4": {
