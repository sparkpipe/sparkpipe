...
static void check_arbitrary_working_sets(void)
{
	...
	SparkWeightdManifest manifest = {0,groups,SPARK_WEIGHTD_LEASE_GROUPS_MAX,SPARK_WEIGHTD_LEASE_GROUPS_MAX,0,0u,0u,0u};
...
int main(void)
{
	...
	SparkWeightdManifest manifest = {0,groups,12u,3u,0,0u,0u,0u};
	SparkWeightdLeaseTable *table;
