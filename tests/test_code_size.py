...
# 240458 (main grew far past this file's stale 233150 pin through the
...
# delta, +51: the dsv4 .experts family manifest producer + the manifest
# selftest). The stale pins above are superseded by this exact measure;
