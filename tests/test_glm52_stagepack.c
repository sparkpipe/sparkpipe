...
#include <cuda_runtime.h> /* internal header contract: CUDA surface types first; stub path via the Makefile rule */
#include "spark_glm52_resident_decode_stage_internal.h" /* former spark_glm52_stagepack_format.h */
