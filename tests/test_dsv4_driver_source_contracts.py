...
def main() -> None:
	...
	require(module, "SparkDsv4ModuleCacheLaneElements(state,kind)", "per-layer compressed cache sizing")
	require(module, "overlap * ratio * overlap * SPARK_DSV4_MODEL_ATTN_HEAD_DIMENSION", "ratio-specific compressor state sizing")
