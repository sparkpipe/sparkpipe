...
def main() -> None:
	...
	require(module, "SparkDsv4PoolBuildLayout(state->first_layer_index", "shared compact pool layout")
	...
	require(module, "SparkDsv4PoolLaneOffset(state->compress_state_offset_by_layer[layer],stride,lane)", "shared compressor lane addressing")
	require(module, "SparkDsv4LaunchResetCompressorState(stream,state->compress_kv_state_f32 + offset,state->compress_score_state_f32 + offset,stride)", "ratio-specific compressor state reset")
	...
	require(firmware, "SPARK_DSV4_RESIDENT_DECODE_STAGE_MAX_RESIDENT_SEQUENCE_COUNT 1024u", "resident lane capacity")
