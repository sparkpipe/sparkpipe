...
int main(void)
{
	...
	assert(deployment.runtime_limits.max_inflight_submission_count == 4u);
	...
	assert(strcmp(node->runtime_root,"/home/sparkc/sparkpipe_runtime/releases/dsv4-flash-0731-ga-7872f01b1d1fe23eabc4c98b48bffcef5a386062") == 0);
