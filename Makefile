...
glm52_resident_decode_stage_firmware_package: glm52_flashinfer_b12x_moe_adapter glm52_b12x_compiled_backend
	...
	. "$(SPARKPIPE_B12X_AOT_ENV)" && \
		...
		$(MAKE) -C modules/glm52_resident_decode_stage package NVCC=$(NVCC) CUDA_ARCH=sm_121a MAX_STAGE_MICROSECONDS=$(MAX_STAGE_MICROSECONDS) REQUIRED_CUDA_CC_ARGS='$(REQUIRED_CUDA_CC_ARGS)' GLM52_REQUIRED_CUDA_LINK_ARGS="$$required_cuda_link_args" B12X_MOE_PACK_DIR='$(abspath $(B12X_MOE_PACK_OUTPUT_DIR))' B12X_MOE_PACK_LAYERS='$(B12X_MOE_PACK_LAYERS)' B12X_MOE_PACK_REQUIRE_REUSE='$(B12X_MOE_PACK_REQUIRE_REUSE)' B12X_MOE_PACK_VERIFY_REUSED_SHA256='$(B12X_MOE_PACK_VERIFY_REUSED_SHA256)' B12X_MOE_PACK_JOBS='$(B12X_MOE_PACK_JOBS)' GLM52_VALIDATION_MODE='$(GLM52_VALIDATION_MODE)' GLM52_VALIDATION_ACTIVE_SEQUENCE_COUNT='$(GLM52_VALIDATION_ACTIVE_SEQUENCE_COUNT)' GLM52_VALIDATION_FIRST_ROUTED_LAYER_INDEX='$(GLM52_VALIDATION_FIRST_ROUTED_LAYER_INDEX)' GLM52_VALIDATION_ROUTED_CHAIN_LAYER_COUNT='$(GLM52_VALIDATION_ROUTED_CHAIN_LAYER_COUNT)' GLM52_PIPELINE_INPUT_HIDDEN_BF16='$(GLM52_PIPELINE_INPUT_HIDDEN_BF16)' GLM52_PIPELINE_OUTPUT_HIDDEN_BF16='$(GLM52_PIPELINE_OUTPUT_HIDDEN_BF16)' GLM52_ENABLE_CUDA_GRAPH_REPLAY='$(GLM52_ENABLE_CUDA_GRAPH_REPLAY)' B12X_PACK_PYTHON="$$SPARKPIPE_B12X_AOT_PYTHON" AOT_MANIFEST='$(abspath $(B12X_AOT_OUTPUT_DIR))/generated/aot_manifest.json'
