...
$(QWEN38_SERVING_ADAPTER): modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_serving_adapter.c modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_paged_kv.c modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_paged_kv.h modules/qwen38_max_resident_decode_stage/include/sparkpipe/spark_qwen38_serving_adapter.h modules/qwen38_max_resident_decode_stage/include/sparkpipe/spark_qwen38_max_resident_decode_stage_firmware.h $(QWEN38_MODEL_DESCRIPTION) $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY)
