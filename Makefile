...
build/dsv4_experts_manifest: tools/dsv4_experts_manifest.c runtime/spark_weightd_manifest.c include/sparkpipe/spark_weightd_manifest.h $(CORE_LIBRARY) | build
	$(CC) $(CORE_INCLUDE_FLAGS) -Imodel-families/dsv4/include -DSPARK_DSV4_PRO_BUILD=1 $(CFLAGS) tools/dsv4_experts_manifest.c runtime/spark_weightd_manifest.c $(CORE_LIBRARY) $(LDFLAGS) $(LDLIBS) -o $@
