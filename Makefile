...
QWEN38_27B_INCLUDE_FLAGS := $(MODEL_COMMON_INCLUDE_FLAGS) -Imodel-families/qwen38_27b/include -Iruntime
QWEN38_INCLUDE_FLAGS := $(MODEL_COMMON_INCLUDE_FLAGS) -Imodel-families/qwen38_max/include -Iruntime
...
QWEN38_MODEL_DESCRIPTION := examples/model_descriptions/qwen38_max_resident_decode_stage_firmware.json
...
QWEN38_SERVING_ADAPTER_FLAGS := -D_POSIX_C_SOURCE=200809L -DQWEN38_MAX_MODEL_REVISION=\"$(QWEN38_MODEL_REVISION)\" -DQWEN38_MAX_CONTRACT_SHA256=\"$(QWEN38_CONTRACT_SHA256)\"
...
TEST_NAMES := \
    ...
    test_kv_store \
    test_kv_cache \
    test_qwen38_27b_prefix_cache \
    test_qwen38_max_prefix_cache \
...
build/test_qwen38_27b_prefix_cache: tests/test_qwen38_27b_prefix_cache.c tests/fixtures/qwen38_27b_serving_adapter_config.json modules/qwen38_27b_resident_decode_stage/source/spark_qwen38_27b_paged_kv.c modules/qwen38_27b_resident_decode_stage/source/spark_qwen38_27b_paged_kv.h build/libqwen38_27b_serving_adapter.dylib build/test_modules/libqwen38_27b_serving_driver_module.dylib $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY)
	$(CC) $(CPPFLAGS) $(QWEN38_27B_INCLUDE_FLAGS) -Imodules/qwen38_27b_resident_decode_stage/include -Imodules/qwen38_27b_resident_decode_stage/source -DTEST_QWEN38_27B_SERVING_ADAPTER_PATH=\"$(QWEN38_27B_SERVING_ADAPTER)\" -DTEST_QWEN38_27B_SERVING_DRIVER_PATH=\"$(TEST_QWEN38_27B_SERVING_DRIVER_MODULE)\" -DTEST_QWEN38_27B_SERVING_CONFIG_PATH=\"tests/fixtures/qwen38_27b_serving_adapter_config.json\" $(CFLAGS) tests/test_qwen38_27b_prefix_cache.c modules/qwen38_27b_resident_decode_stage/source/spark_qwen38_27b_paged_kv.c $(SPARKPIPE_HOST_CUDA_STUB_SOURCE) $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY) $(LDFLAGS) $(LDLIBS) $(SPARKPIPE_CUDA_RUNTIME_LINK) -o $@

# qwen38-max (port 2): serving adapter dylib over the paged KV + core.
$(QWEN38_SERVING_ADAPTER): modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_serving_adapter.c modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_paged_kv.c modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_paged_kv.h modules/qwen38_max_resident_decode_stage/include/sparkpipe/spark_qwen38_max_serving_adapter.h modules/qwen38_max_resident_decode_stage/include/sparkpipe/spark_qwen38_max_resident_decode_stage_firmware.h $(QWEN38_MODEL_DESCRIPTION) $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY)
	$(CC) $(CPPFLAGS) $(QWEN38_INCLUDE_FLAGS) -Imodules/qwen38_max_resident_decode_stage/include $(CFLAGS) $(QWEN38_SERVING_ADAPTER_FLAGS) -fPIC $(SHARED_LIBRARY_FLAGS) modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_serving_adapter.c modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_paged_kv.c $(SPARKPIPE_HOST_CUDA_STUB_SOURCE) $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY) $(LDFLAGS) $(LDLIBS) $(SPARKPIPE_CUDA_RUNTIME_LINK) -o $@

$(TEST_QWEN38_SERVING_DRIVER_MODULE): tests/fixtures/qwen38_max_serving_adapter_driver.c modules/qwen38_max_resident_decode_stage/include/sparkpipe/spark_qwen38_max_resident_decode_stage_firmware.h include/sparkpipe/spark_model_driver.h include/sparkpipe/spark_model_driver_support.h $(QWEN38_MODEL_DESCRIPTION) | build/test_modules
	$(CC) $(CPPFLAGS) $(QWEN38_INCLUDE_FLAGS) -Imodules/qwen38_max_resident_decode_stage/include $(CFLAGS) $(QWEN38_SERVING_ADAPTER_FLAGS) -fPIC $(SHARED_LIBRARY_FLAGS) $< $(SPARKPIPE_HOST_CUDA_STUB_SOURCE) $(LDFLAGS) $(LDLIBS) $(SPARKPIPE_CUDA_RUNTIME_LINK) -o $@

build/test_qwen38_max_prefix_cache: tests/test_qwen38_max_prefix_cache.c tests/fixtures/qwen38_max_serving_adapter_config.json tests/fixtures/qwen38_max_serving_adapter_config_squeezed.json modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_paged_kv.c modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_paged_kv.h build/libqwen38_serving_adapter.dylib build/test_modules/libqwen38_serving_driver_module.dylib $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY)
	$(CC) $(CPPFLAGS) $(QWEN38_INCLUDE_FLAGS) -Imodules/qwen38_max_resident_decode_stage/include -Imodules/qwen38_max_resident_decode_stage/source -DTEST_QWEN38_SERVING_ADAPTER_PATH=\"$(QWEN38_SERVING_ADAPTER)\" -DTEST_QWEN38_SERVING_DRIVER_PATH=\"$(TEST_QWEN38_SERVING_DRIVER_MODULE)\" -DTEST_QWEN38_SERVING_CONFIG_PATH=\"tests/fixtures/qwen38_max_serving_adapter_config.json\" -DTEST_QWEN38_SERVING_SQUEEZED_CONFIG_PATH=\"tests/fixtures/qwen38_max_serving_adapter_config_squeezed.json\" $(CFLAGS) tests/test_qwen38_max_prefix_cache.c modules/qwen38_max_resident_decode_stage/source/spark_qwen38_max_paged_kv.c $(SPARKPIPE_HOST_CUDA_STUB_SOURCE) $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY) $(LDFLAGS) $(LDLIBS) $(SPARKPIPE_CUDA_RUNTIME_LINK) -o $@
