...
build/dsv4_experts_manifest: tools/dsv4_experts_manifest.c runtime/spark_weightd_manifest.c include/sparkpipe/spark_weightd_manifest.h $(CORE_LIBRARY) | build
	$(CC) $(CORE_INCLUDE_FLAGS) -Imodel-families/dsv4/include $(CFLAGS) tools/dsv4_experts_manifest.c runtime/spark_weightd_manifest.c $(CORE_LIBRARY) $(LDFLAGS) $(LDLIBS) -o $@
