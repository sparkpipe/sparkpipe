...
#   per REV2 A12 - it feeds no gate); the compute-capability pair is pinned
#   to the public CDNA4 spec and to what the in-tree target guard already
#   requires (gfx950 reports 9.5) - same pin as the C header. Every other
#   numeric stays unpinned.
