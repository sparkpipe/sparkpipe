...
for i in $(seq 0 15); do
  ...
  fi
  {
    ...
    # The context axis in MODEL units: the adapter derives the MLA page
    # count over K3_KV_PAGE_SLOTS (64-token pages). A pinned "kv_pages": 2
    # here was one 128-token cache - every ctx512/ctx2048 cell died on it.
    echo "  \"context_tokens\": 4096,"
