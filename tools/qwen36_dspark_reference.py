...
# Merge consolidation: accept either override - main's DFLASH2-specific
# name first, unified's generic name as fallback.
TARGET = Path(
    os.environ.get("SPARK_QWEN36_DFLASH2_TARGET")
    or os.environ.get("SPARK_QWEN36_TARGET")
    or "/home/spark3/extnvme/models/hf/Qwen/Qwen3.8-27B"
)
