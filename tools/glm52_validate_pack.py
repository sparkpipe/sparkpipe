...
Mirrors the SparkGlm52StagePackExpectedShape geometry table in
modules/glm52_resident_decode_stage/source/spark_glm52_resident_decode_stage_internal.h
(former spark_glm52_stagepack_format.h, folded by the cleanup round)
+ ExpectedPayloadBytes/ExpectedScaleBytes and
