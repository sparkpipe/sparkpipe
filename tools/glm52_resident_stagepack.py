...
Wire format: the stage-pack contract in modules/glm52_resident_decode_stage/source/spark_glm52_resident_decode_stage_internal.h (former spark_glm52_stagepack_format.h)
