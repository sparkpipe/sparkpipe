...
def build_parser() -> argparse.ArgumentParser:
    ...
    submit.add_argument("--local-jobs", default=16, type=int)
    ...
    queue_depth_parser.add_argument("--max-jobs", default=16, type=int)
    ...
    serve.add_argument("--max-jobs", default=16, type=int)
