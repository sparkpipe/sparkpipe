...
# Wire constants, mirroring the qwen38 stage-pack contract in
# modules/qwen38_resident_decode_stage/source/spark_qwen38_resident_decode_stage_internal.h
# (former spark_qwen38_stagepack_format.h).
...
def main() -> int:
    ...
    receipt = {
        ...
        # Receipt truthfulness (audit section 6): this tool emits the VENDOR
        # FP8 form for routed experts (WEIGHT_FP8_F32B128) - label what is
        # actually in the pack, not the aspirational ladder target.
        "weight_formats": {"routed_experts": "fp8_e4m3_f32b128",
                           "non_expert": "bf16",
