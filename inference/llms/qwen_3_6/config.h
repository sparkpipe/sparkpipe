...
// QWEN38_27B_LAYER_IS_LINEAR computes: layers 0,1,2 linear and 3 full, repeating.
//
...
#define QWEN38_27B_HIDDEN 5120u                    /* CONFIG hidden_size */
#define QWEN38_27B_LAYERS 64u                      /* CONFIG num_hidden_layers */
#define QWEN38_27B_VOCAB 248320u                   /* CONFIG vocab_size, padded */
#define QWEN38_27B_RMS_EPSILON 1e-06f              /* CONFIG rms_norm_eps */
#define QWEN38_27B_FFN_INTERMEDIATE 17408u         /* CONFIG intermediate_size */

#define QWEN38_27B_ATTENTION_PERIOD 4u             /* CONFIG full_attention_interval */
#define QWEN38_27B_FULL_PHASE 3u                   /* CONFIG layer_types order */
...
#define QWEN38_27B_ATTN_HEADS 24u                  /* CONFIG num_attention_heads */
#define QWEN38_27B_KV_HEADS 4u                     /* CONFIG num_key_value_heads */
#define QWEN38_27B_HEAD_DIM 256u                   /* CONFIG head_dim */
#define QWEN38_27B_ROPE_DIM 64u                    /* CONFIG partial_rotary_factor 0.25 x 256 */
#define QWEN38_27B_NOPE_DIM (QWEN38_27B_HEAD_DIM - QWEN38_27B_ROPE_DIM)
#define QWEN38_27B_ROPE_THETA 10000000.0f          /* CONFIG rope_theta */
#define QWEN38_27B_QK_SCALE 0.0625f                /* 1 / sqrt(256) */
#define QWEN38_27B_ATTN_OUTPUT_GATE 1u             /* CONFIG attn_output_gate */
...
#define QWEN38_27B_GDN_KEY_HEADS 16u               /* CONFIG linear_num_key_heads */
#define QWEN38_27B_GDN_VALUE_HEADS 48u             /* CONFIG linear_num_value_heads */
#define QWEN38_27B_GDN_KEY_DIM 128u                /* CONFIG linear_key_head_dim */
#define QWEN38_27B_GDN_VALUE_DIM 128u              /* CONFIG linear_value_head_dim */
#define QWEN38_27B_GDN_CONV_KERNEL 4u              /* CONFIG linear_conv_kernel_dim */
...
#define QWEN38_27B_MTP_LAYERS 1u                   /* CONFIG mtp_num_hidden_layers */
