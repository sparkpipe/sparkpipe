...
template __global__ void LmRopePerHeadKernel<QWEN38_27B_THREADS>(uint16_t *, const uint32_t *, uint32_t, uint32_t, uint32_t, float, const float *, float, uint32_t);
...
template __global__ void LmDeltaRuleKernel<QWEN38_27B_THREADS, QWEN38_27B_GDN_KEY_DIM, QWEN38_27B_GDN_VALUE_DIM>(uint8_t *, uint32_t, const uint32_t *, const uint32_t *, const uint32_t *, const uint16_t *, const uint16_t *, const uint16_t *, const float *, const float *, uint16_t *, uint32_t, uint32_t, uint32_t, uint32_t, const uint32_t *);
...
template __global__ void LmCausalConvKernel<QWEN38_27B_THREADS, QWEN38_27B_GDN_CONV_KERNEL, LM_CONV_SWISH,uint16_t>(uint16_t *, const uint32_t *, const uint32_t *, const uint32_t *, const uint16_t *, const uint16_t *, uint16_t *, uint32_t, uint32_t, uint32_t, const uint32_t *);
