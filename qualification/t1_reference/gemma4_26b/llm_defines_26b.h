...
#define SPARK_LLM_HIDDEN_DIMENSION              2816u
#define SPARK_LLM_LAYER_COUNT                   30u
...
#define SPARK_LLM_EMBED_SCALE                   53.0f

#define SPARK_LLM_SLIDING_QUERY_HEAD_COUNT      16u
#define SPARK_LLM_SLIDING_KV_HEAD_COUNT         8u
...
#define SPARK_LLM_FULL_QUERY_HEAD_COUNT         16u
#define SPARK_LLM_FULL_KV_HEAD_COUNT            2u
...
#define SPARK_LLM_DENSE_INTERMEDIATE_DIMENSION  2112u

#define SPARK_LLM_ROUTED_EXPERT_COUNT           128u
#define SPARK_LLM_EXPERTS_PER_TOKEN             8u
#define SPARK_LLM_EXPERT_INTERMEDIATE_DIMENSION 704u
