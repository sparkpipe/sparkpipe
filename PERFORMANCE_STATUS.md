...
### DSV4 Flash TP4 B1 context matrix (2026-08-25)

Measured on the live serving ring (spark4-7, control 18480, runtime
/tmp/dsv4-integrated-lean-3d962820-runtime, driver 4675e35fa5a20349 built
from ef8fa302). Pre-check: canonical O128 decode 40.59 tok/s with the exact
pinned token hash a9385d0b296ca083. Per cell: one discarded warmup plus
three measured runs; means below. TTFT is process-start to first token;
TTFB is the accepted-event to first-token interval (transport-pure prefill);
E2E is total completion time.

| Cell | Decode tok/s | TTFT s | TTFB s | E2E s |
| ---: | ---: | ---: | ---: | ---: |
| decode ctx512 B1 | 39.15 | 13.95 | 13.56 | 17.19 |
| decode ctx2048 B1 | 37.44 | 55.76 | 55.29 | 59.16 |
| prefill ctx512 B1 (eff. 37.6 tok/s) | n/a | 13.91 | 13.60 | 13.95 |
| prefill ctx2048 B1 (eff. 37.0 tok/s) | n/a | 55.74 | 55.28 | 55.78 |

Prefill marginal rate across the 512-to-2048 delta is 36.8 tok/s: flat.
Prefix caching ON-vs-OFF delta is structurally zero at this generation
(client-process-local cache, single-row submissions); see
[the analysis](qualification/dsv4/performance/tp4_b1_matrix_20260825/prefix_cache_on_off_analysis.md).
Width-4 and width-16 drivers built for the wide cells compile but fail
tp_graph_projection_island graph capture at adapter_initialize; the cells
are blocked pending upstream graph-capture work.

| Receipt | SHA-256 |
| --- | --- |
| [health-o128.json](qualification/dsv4/performance/tp4_b1_matrix_20260825/receipts/health-o128.json) | dcdcbb9a7e616793a799214695439fd1f94267be3ba6f3a5ac8b2ed5d0fa2c8c |
| [live-d512b1-r1.json](qualification/dsv4/performance/tp4_b1_matrix_20260825/receipts/live-d512b1-r1.json) | 4642ed182071b452db2ee42cdafe6dab8ff092306ab0bff2077516277666e93e |
| [live-d2048b1-r1.json](qualification/dsv4/performance/tp4_b1_matrix_20260825/receipts/live-d2048b1-r1.json) | 81c47f62a0bc43090a244fe891087f6990692b0dd4d1744bfcdb88806298cde7 |
| [live-p512b1-r1.json](qualification/dsv4/performance/tp4_b1_matrix_20260825/receipts/live-p512b1-r1.json) | 92de76ec3f985402d9a392008679f05711ab19038ab8a7eb79426c3816fd33f2 |
| [live-p2048b1-r1.json](qualification/dsv4/performance/tp4_b1_matrix_20260825/receipts/live-p2048b1-r1.json) | 4120773f86024f721e35188e3ab062650864f4fee39922e07d3c02f59285cf28 |
