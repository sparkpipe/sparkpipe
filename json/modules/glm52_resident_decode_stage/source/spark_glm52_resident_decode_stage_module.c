...
/* The stage-pack wire contract (former spark_glm52_stagepack_format.h,
 * deleted by the cleanup round) lives in the internal header above;
 * mechanics come from runtime/spark_stagepack_reader.h through it. */
