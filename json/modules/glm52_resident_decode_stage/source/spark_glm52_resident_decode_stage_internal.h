...
#endif
/*
 * Stage-pack wire contract, glm52 dialect - formerly the standalone
 * source/spark_glm52_stagepack_format.h (cleanup round 2026-08-24). The
 * mechanics live in runtime/spark_stagepack_reader.h; this is the family
 * residue (constants, kind ids, header/entry layout, per-kind geometry),
 * verbatim so tests/test_stagepack_parity.py keeps pinning parse behavior
 * byte-identical to the frozen reference under tests/fixtures/stagepack_parity/glm52/.
 */
