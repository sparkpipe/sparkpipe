...
/*
 * Stage-pack wire contract, Qwen 3.6 dialect - formerly the standalone
 * source/spark_qwen36_stagepack_format.h (cleanup round 2026-08-24). The
 * mechanics live in runtime/spark_stagepack_reader.h (through the hybrid
 * compatibility names); this is the family residue (constants, kind ids,
 * header/entry layout, per-kind geometry table), so
 * tests/test_stagepack_parity.py keeps pinning parse behavior byte-identical
 * to the frozen reference under tests/fixtures/stagepack_parity/qwen36/.
 */
...
// shared reader's (runtime/spark_stagepack_reader.h).
#define SPARK_QWEN36_STAGEPACK_CLASS_GLOBAL SPARK_STAGE_PACK_LAYER_CLASS_GLOBAL
#define SPARK_QWEN36_STAGEPACK_CLASS_EVERY_LAYER SPARK_STAGE_PACK_LAYER_CLASS_EVERY_LAYER
#define SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER SPARK_STAGE_PACK_LAYER_CLASS_GDN_LAYER
#define SPARK_QWEN36_STAGEPACK_CLASS_ATTN_LAYER SPARK_STAGE_PACK_LAYER_CLASS_ATTN_LAYER
...
// in the shared reader.
static inline uint32_t SparkQwen36StagePackFullAttentionLayersBelow(uint32_t layer_count)
{
	return(SparkStagePackFullAttentionLayersBelow(SPARK_QWEN36_MODEL_ATTENTION_PERIOD,layer_count));
}
 ...
 * The arithmetic is the shared periodic-slice inventory; this family's part
 * is only its constant row.
 */
#define SPARK_QWEN36_STAGEPACK_INVENTORY_PERIODIC \
	SPARK_QWEN36_MODEL_LAYER_COUNT,SPARK_QWEN36_MODEL_ATTENTION_PERIOD,5u,9u,6u,17u,1u

static inline uint32_t SparkQwen36StagePackExpectedTensorCount(uint32_t first_layer_index, uint32_t layer_count)
{
	return(SparkStagePackPeriodicSliceInventory(first_layer_index,layer_count,
		SPARK_QWEN36_STAGEPACK_INVENTORY_PERIODIC));
}
...
/*
 * The per-kind geometry-and-sharding table - the model-specific part of this
 * family, as data rather than as five switches of case lines. One row per
 * tensor kind: layer class, natural wire format, unpacked shape, whether the
 * kind may travel quantized, and its TP shard axis. The reader mechanics
 * around these rows live in runtime/spark_stagepack_reader.h.
 */
typedef struct SparkQwen36StagePackKindGeometry
{
	uint32_t rows;
	uint32_t columns;
	uint32_t natural_format;
...
SparkQwen36StagePackKindGeometry;

#define SPARK_QWEN36_STAGEPACK_SHARD_NONE 0u
#define SPARK_QWEN36_STAGEPACK_SHARD_ROWS 1u
#define SPARK_QWEN36_STAGEPACK_SHARD_COLUMNS 2u
/* The fused GDN q|k|v projection is stitched q|k|v per rank, so its sharded
 * row count is (2*qk + v) / degree rather than a plain axis division. */
#define SPARK_QWEN36_STAGEPACK_SHARD_GDN_QKV_STITCH 3u

#define SPARK_QWEN36_GEOM_ROW(kind,class,format,rows_expression,columns_expression,quantizes,shards) \
	[kind] = {rows_expression,columns_expression,format,quantizes,class,shards}

static const SparkQwen36StagePackKindGeometry SPARK_QWEN36_STAGEPACK_KIND_GEOMETRY[SPARK_QWEN36_STAGEPACK_TENSOR_KIND_COUNT] =
{
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_EMBEDDING,SPARK_QWEN36_STAGEPACK_CLASS_GLOBAL,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_OUTPUT_VOCAB_COUNT,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_FINAL_NORM,SPARK_QWEN36_STAGEPACK_CLASS_GLOBAL,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_LM_HEAD,SPARK_QWEN36_STAGEPACK_CLASS_GLOBAL,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_OUTPUT_VOCAB_COUNT,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_ROWS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_ATTENTION_NORM,SPARK_QWEN36_STAGEPACK_CLASS_EVERY_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_MLP_NORM,SPARK_QWEN36_STAGEPACK_CLASS_EVERY_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_FFN_GATE,SPARK_QWEN36_STAGEPACK_CLASS_EVERY_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_FFN_INTERMEDIATE_DIMENSION,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_ROWS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_FFN_UP,SPARK_QWEN36_STAGEPACK_CLASS_EVERY_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_FFN_INTERMEDIATE_DIMENSION,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_ROWS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_FFN_DOWN,SPARK_QWEN36_STAGEPACK_CLASS_EVERY_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,SPARK_QWEN36_MODEL_FFN_INTERMEDIATE_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_COLUMNS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_QKV,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_GDN_CONV_CHANNELS,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_GDN_QKV_STITCH),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_GATE,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_GDN_VALUE_DIMENSION,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_BETA,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_GDN_VALUE_HEAD_COUNT,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_DECAY,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_GDN_VALUE_HEAD_COUNT,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_OUTPUT,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,SPARK_QWEN36_MODEL_GDN_VALUE_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_COLUMNS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_CONV_WEIGHT,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_GDN_CONV_CHANNELS,SPARK_QWEN36_MODEL_GDN_CONV_KERNEL,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_A_LOG,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_F32,1u,SPARK_QWEN36_MODEL_GDN_VALUE_HEAD_COUNT,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_DT_BIAS,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_F32,1u,SPARK_QWEN36_MODEL_GDN_VALUE_HEAD_COUNT,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_GDN_NORM,SPARK_QWEN36_STAGEPACK_CLASS_GDN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_GDN_HEAD_VALUE_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_ATTN_QUERY,SPARK_QWEN36_STAGEPACK_CLASS_ATTN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,2u * SPARK_QWEN36_MODEL_ATTN_QUERY_DIMENSION,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_ROWS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_ATTN_KEY,SPARK_QWEN36_STAGEPACK_CLASS_ATTN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_ATTN_KV_DIMENSION,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_ROWS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_ATTN_VALUE,SPARK_QWEN36_STAGEPACK_CLASS_ATTN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_ATTN_KV_DIMENSION,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_ROWS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_ATTN_OUTPUT,SPARK_QWEN36_STAGEPACK_CLASS_ATTN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,SPARK_QWEN36_MODEL_ATTN_QUERY_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_COLUMNS),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_ATTN_QUERY_NORM,SPARK_QWEN36_STAGEPACK_CLASS_ATTN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_ATTN_HEAD_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_ATTN_KEY_NORM,SPARK_QWEN36_STAGEPACK_CLASS_ATTN_LAYER,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_ATTN_HEAD_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_MTP_FC,SPARK_QWEN36_STAGEPACK_CLASS_GLOBAL,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,2u * SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,1u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_MTP_EMBED_NORM,SPARK_QWEN36_STAGEPACK_CLASS_GLOBAL,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_MTP_HIDDEN_NORM,SPARK_QWEN36_STAGEPACK_CLASS_GLOBAL,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE),
	SPARK_QWEN36_GEOM_ROW(SPARK_QWEN36_STAGEPACK_TENSOR_MTP_FINAL_NORM,SPARK_QWEN36_STAGEPACK_CLASS_GLOBAL,SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_BF16,1u,SPARK_QWEN36_MODEL_HIDDEN_DIMENSION,0u,SPARK_QWEN36_STAGEPACK_SHARD_NONE)
};

#undef SPARK_QWEN36_GEOM_ROW

static inline int32_t SparkQwen36StagePackTensorShapeOf(uint32_t tensor_kind, SparkQwen36StagePackTensorShape *shape)
{
	const SparkQwen36StagePackKindGeometry *geometry;
	if ( tensor_kind >= SPARK_QWEN36_STAGEPACK_TENSOR_KIND_COUNT )
		return(-1);
	geometry = &SPARK_QWEN36_STAGEPACK_KIND_GEOMETRY[tensor_kind];
	shape->rows = geometry->rows;
	shape->columns = geometry->columns;
	shape->natural_format = geometry->natural_format;
	shape->quantizable = geometry->quantizable;
 ...
 */
/*
 * TP packs store one rank's row/column window of each shardable tensor; the
 * shard axis of every kind rides the geometry table. Replicated kinds (the
 * embedding, norms, conv, gates, beta/decay, MTP) are unchanged - the
 * embedding deliberately so: no collective broadcast primitive yet, every
 * rank gathers from the full table (matches the packer's TP plan). The
 * historical doctrine divides WITHOUT a divisibility check; a non-divisible
 * degree truncates rather than rejects, and that acceptance is pinned.
 */
...
{
	if ( tp_degree <= 1u || tensor_kind >= SPARK_QWEN36_STAGEPACK_TENSOR_KIND_COUNT )
		return;
	switch ( SPARK_QWEN36_STAGEPACK_KIND_GEOMETRY[tensor_kind].shard_axis )
	{
	case SPARK_QWEN36_STAGEPACK_SHARD_ROWS:
		shape->rows /= tp_degree;
		break;
	case SPARK_QWEN36_STAGEPACK_SHARD_COLUMNS:
		shape->columns /= tp_degree;
		break;
	case SPARK_QWEN36_STAGEPACK_SHARD_GDN_QKV_STITCH:
...
static inline int32_t SparkQwen36StagePackResolvedShape(uint32_t tensor_kind, uint32_t layer_index, uint32_t is_global, uint32_t tp_degree, SparkQwen36StagePackTensorShape *shape)
{
	 ...
	 * stack bound, hybrid-map class check - is the shared reader's, with its
...
static inline uint32_t SparkQwen36StagePackWeightClass(uint32_t weight_format)
{
	if ( weight_format == SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_MXFP4_E2M1 )
		return(SPARK_STAGE_PACK_WEIGHT_NIBBLE_E2M1);
	if ( weight_format == SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_FP8_E4M3_F32B128 )
		return(SPARK_STAGE_PACK_WEIGHT_FP8_E4M3_F32B128);
	/* Merge consolidation: origin/main's MX serving format (e8m0-tiled fp8)
	 * joins the forward map; its byte accounting lives in the shared reader
	 * (payload 1 B/element, scale rows x columns/128 e8m0). */
	if ( weight_format == SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_FP8_E4M3_E8M0B128 )
		return(SPARK_STAGE_PACK_WEIGHT_FP8_E4M3_E8M0B128);
	if ( weight_format == SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_F32 )
		return(SPARK_STAGE_PACK_WEIGHT_F32);
	if ( weight_format == SPARK_QWEN36_RESIDENT_DECODE_STAGE_WEIGHT_FORMAT_U32 )
		return(SPARK_STAGE_PACK_WEIGHT_U32);
	return(SPARK_STAGE_PACK_WEIGHT_BF16);
}

static inline uint64_t SparkQwen36StagePackPayloadBytes(uint32_t weight_format, uint32_t rows, uint32_t columns)
{
	return(SparkStagePackWeightPayloadBytes(SparkQwen36StagePackWeightClass(weight_format),rows,columns));
}

static inline uint64_t SparkQwen36StagePackScaleBytes(uint32_t weight_format, uint32_t rows, uint32_t columns)
{
	return(SparkStagePackWeightScaleBytes(SparkStagePackWeightClassAccounting(SparkQwen36StagePackWeightClass(weight_format)),rows,columns));
}