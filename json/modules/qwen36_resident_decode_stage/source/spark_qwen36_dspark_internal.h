...
/*
 * DFlash2 drafter pack wire contract, Qwen 3.6 lane - formerly the standalone
 * source/spark_qwen36_dspark_format.h (cleanup round 2026-08-24), verbatim so
 * the drafter TUs in this directory and validation/ keep one include name.
 */
