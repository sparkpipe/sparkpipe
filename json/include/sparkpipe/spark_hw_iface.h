...
//
//   cuda.sm121.gb10    -> spark_hw_cuda_*  (dsv4_cuda_sm121_gb10 archive)
//   rocm.gfx950.mi350p -> spark_hw_rocm_*  (dsv4_rocm_gfx950_mi350p archive)
//
 ...
 * translation is an identity mapping. Unknown flag bits are refused with
