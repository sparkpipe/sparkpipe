...
2. Extend sampled checkpoint-derived CPU/reference checks to full-vector checksums or external reference activations for layer 0.
3. Extend the checkpoint-derived prefill/KV fixture beyond the checked B1 context-4 window and compare full post-attention and layer-output activations against an external reference.
