...
2. Replace smoke tensors with checkpoint-derived deterministic GLM tensor fixtures for cached attention and MTP verify/commit; restricted logits now have a live `lm_head.weight` row validator and must be extended to final full-checkpoint logits.
