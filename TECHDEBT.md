...
## DSV4-Pro qualification

- Retain a Pro (h7168/l61) full-stage reference fixture plus manifest and
  pin its SHA-256 in Makefile.pro, so the slice-independent oracle gate in
  validate_dsv4_resident_decode_stage_cuda.sh covers the default Pro
  archive and not only the Flash stage-0 layers 0..2 fixture. Until the
  fixture lands, Pro archives carry no end-to-end numerical oracle.
