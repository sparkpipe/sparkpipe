...
/* Single-resolve admission query: materializes the lane page chain AND its
 * one-page mutable demand from ONE identity lookup. Equivalent to calling
 * ResolveLanePages followed by GetLaneMutablePageDemand. */
